...
% --- Рисунки/таблицы ---
\usepackage{graphicx}
\usepackage[font={small,bf},labelsep=period,singlelinecheck=false]{caption}
...
\makeatletter
\def\bicaption@tablestr{table}
\newcommand{\bicaption}[2]{%
	\caption{#1}%
	\vspace{-0.7em}
	{\captionsetup{labelformat=empty}%
		\edef\bicaption@type{\@captype}%
		\ifx\bicaption@type\bicaption@tablestr
			\caption*{\textbf{Table~\thetable.} #2}%
		\else
