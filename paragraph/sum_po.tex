Программный комплекс реализует предложенные этапы оцифровки книг (сегментации страницы на логические блоки, предобработка изображений, специализированных методов извлечения). Пример работы программы и промежуточные этапы представлены на рис.~\ref{fig:example_prog}.

\begin{figure*}[t]
	\centering
	\includegraphics[width=1\linewidth]{img/example_prog.jpg}
	\bicaption
