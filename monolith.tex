...
В данной работе рассматривается подход к комплексной оцифровке химической литературы, ориентированный не только на извлечение текстового слоя, но и на распознавание и структурирование графической химической информации, что позволяет разработать систему интеллектуального поиска по книгам.  \section{Классификация машинного зрения}
...
\begin{figure*}[hbtp]
	...
	\begin{tabular}{cc}
		...
		\includegraphics[width=0.45\linewidth]{img/classifications_ai.png} \\
		a$)$ & b$)$	\textcolor{red}{ИЗМЕНИТЬ рис. b}
	\end{tabular}
	\bicaption
	{
...
Эти факторы напрямую влияют на точность распознания как и графических формул и реакций так и текста. Поэтому перед обработкой самой OCR и OCSR необходимо сделать пред обработку и нормализацию изображения. 
...
\bibitem{refLineAngle}
Chapter 1 - Organic Chemistry Review / Hydrocarbons. Section 1.4 Condensed Structural and Line-Angle Formulas. – Text: electronic // Hostos Community College Library Guides. – URL: https://guides.hostos.cuny.edu/che120 (accessed: May 22, 2026). 	\end{thebibliography}
\end{strip}
